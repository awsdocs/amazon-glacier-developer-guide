# Authentication and Access Control for Amazon S3 Glacier<a name="auth-and-access-control"></a>

Access to Amazon S3 Glacier \(Glacier\) requires credentials that AWS can use to authenticate your requests\. Those credentials must have permissions to access AWS resources, such as a Glacier vault or an Amazon S3 bucket\. The following sections provide details on how you can use [AWS Identity and Access Management \(IAM\)](https://docs.aws.amazon.com/IAM/latest/UserGuide/introduction.html) and Glacier to help secure your resources by controlling who can access them:
...
You can have valid credentials to authenticate your requests, but unless you have permissions you cannot create or access Glacier resources\. For example, you must have permissions to create a Glacier vault\. 
