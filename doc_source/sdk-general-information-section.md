# Using S3 Glacier with an AWS SDK<a name="sdk-general-information-section"></a>
...
For examples specific to S3 Glacier, see [Code examples for S3 Glacier using AWS SDKs](service_code_examples.md)\.
